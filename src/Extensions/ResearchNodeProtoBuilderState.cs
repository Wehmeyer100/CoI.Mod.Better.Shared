...
namespace CoI.Mod.Better.Shared.Extensions
{
	public static class ResearchNodeProtoBuilderState
	{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static ResearchNodeProto AddParentPlusGridPos(this ResearchNodeProto builder, ResearchNodeProto parentProto, int ui_stepSize_x = Constants.UIStepSize, int ui_stepSize_y = 0)
		{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static ResearchNodeProto AddGridPos(this ResearchNodeProto builder, ResearchNodeProto parentProto, int ui_stepSize_x = Constants.UIStepSize, int ui_stepSize_y = 0)
		{
