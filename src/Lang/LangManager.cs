...
namespace CoI.Mod.Better.Shared.Lang
{
	public class LangManager
	{
		...
		public LangManager()
		{
			...
			if (!Directory.Exists(Path.Combine(Constants.LangDirPath, CurrentLang)))
			{
				CurrentLang = "en-US";
			}
		...
		public void Load()
		{
			string dirPath = Path.Combine(Constants.LangDirPath, CurrentLang);
